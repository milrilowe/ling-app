...
export function PushToTalkButton({
  ...
  return (
    <div className={cn('flex flex-col items-center gap-4', className)}>
      {/* Recording timer - fixed height container to prevent layout shift */}
      ...
      {/* Main button - wrapped in fixed container to prevent scale from affecting layout */}
      ...
      {/* Hint text and error message - fixed height container to prevent layout shift */}
